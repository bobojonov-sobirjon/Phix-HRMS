"""fix_otp_type_field_length

Revision ID: 9fa40c75dcca
Revises: 44fcefde72d6
Create Date: 2025-08-27 11:12:26.177179
...
revision = '9fa40c75dcca'
down_revision = '44fcefde72d6'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    # Fix OTP field length to accommodate longer otp_type values
    op.alter_column('otps', 'otp_type',
    ...
    op.alter_column('team_members', 'status',
               existing_type=postgresql.ENUM('PENDING', 'ACCEPTED', 'REJECTED', name='teammemberstatus'),
               nullable=True)
...
def downgrade() -> None:
    ...
    # Revert OTP field length change
    op.alter_column('otps', 'otp_type',
