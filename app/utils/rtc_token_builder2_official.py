...
class RtcTokenBuilder:
    ...
    def build_token_with_uid(app_id, app_certificate, channel_name, uid, role, token_expire, privilege_expire=0):
        ...
        :param uid: User ID. A 32-bit unsigned integer with a value ranging from 1 to (2^32-1).
            uid must be unique. Use 0 for auto-assign.
        ...
        if role == Role_Publisher:
            ...
            service_rtc.add_privilege(ServiceRtc.kPrivilegePublishVideoStream, privilege_expire_ts)
            service_rtc.add_privilege(ServiceRtc.kPrivilegePublishDataStream, privilege_expire_ts)
