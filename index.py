...
# Try to import from agora_token_builder package first
try:
    from agora_token_builder.RtcTokenBuilder2 import RtcTokenBuilder, RtcTokenBuilder2, Role_Publisher, Role_Subscriber
except ImportError:
    # Fallback to local implementation
    sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), 'app', 'utils')))
    from rtc_token_builder2_official import RtcTokenBuilder, RtcTokenBuilder2, Role_Publisher, Role_Subscriber
